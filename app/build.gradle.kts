...
android {
    namespace = "uk.ac.tees.mad.D3662700"
    compileSdk = 34

    defaultConfig {
        applicationId = "uk.ac.tees.mad.D3662700"
        minSdk = 27
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    implementation("androidx.lifecycle:lifecycle-runtime-ktx:2.6.1") // Updated version
    implementation("androidx.activity:activity-compose:1.7.0") // Updated version
